...
import { getInstanceById } from 'apiSdk/instances';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('instance', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/instances/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Whatsapp Number" text={data?.whatsapp_number} />

                <FormListItem label="Webhook Url" text={data?.webhook_url} />

                <FormListItem label="Qr Code Url" text={data?.qr_code_url} />
                ...
                {hasAccess('agent', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Agent"
                    text={
                      <Link as={NextLink} href={`/agents/view/${data?.agent?.id}`}>
                        {data?.agent?.name}
                      </Link>
                    }
                  />
