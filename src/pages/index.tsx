...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`ZapEdu v2`}</title>

        <meta
          name="description"
          content="Experience seamless management with ZapEdu v2 - Empowering administrators and users to effectively manage Agents and Instances. Monitor performance, assign roles, and ensure quality tutoring services."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless management with ZapEdu v2 - Empowering administrators and users to effectively manage Agents and Instances. Monitor performance, assign roles, and ensure quality tutoring services.`}
            </Text>
            <Box
